...
#ifndef CFG_Config_DMAC01_H
#define CFG_Config_DMAC01_H
...
#define _DMAC01_TRANSFER_COUNT                (0x00000000UL)
...
void R_Config_DMAC01_Create_UserInit(void);
